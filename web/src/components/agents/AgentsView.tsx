...
const ROLE_DOT: Record<string, string> = {
  ...
  'integration-test': 'bg-cyan-500',
  'skill-gen': 'bg-pink-500',
...
const ROLE_BG: Record<string, string> = {
  ...
  'integration-test': 'bg-cyan-500/10 text-cyan-400',
  'skill-gen': 'bg-pink-500/10 text-pink-400',
              ...
              return (
                <>
                  ...
                  {groups.map(g => {
                    ...
                    return (
                      <div key={g.taskId} className="rounded-lg border-2 border-border bg-card overflow-hidden group dark:border-white/20">
                        {/* Group header */}
                        <div
